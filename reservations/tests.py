...
class ReservationPermissionTest(TestCase):
    ...
    def test_ceo_can_access_list(self):
        ...
        self.assertEqual(
            self.client.get(reverse("reservations:reservation_list")).status_code, 200
        )
    ...
    def test_customer_cannot_access_list(self):
        ...
        self.assertEqual(
            self.client.get(reverse("reservations:reservation_list")).status_code, 403
        )
...
class ReservationListViewTest(TestCase):
    ...
    def test_requires_login(self):
        ...
        self.assertRedirects(
            response,
            reverse("login") + "?next=/reservations/",
...
class ReservationCreateViewTest(TestCase):
    ...
    def test_requires_login(self):
        ...
        self.assertRedirects(
            response,
            reverse("login") + "?next=/reservations/create/",
            fetch_redirect_response=False,
        )
...
class RoomStatusViewTest(TestCase):
    ...
    def test_requires_login(self):
        ...
        self.assertRedirects(
            response,
            reverse("login") + "?next=/reservations/room-status/",
            fetch_redirect_response=False,
        )
