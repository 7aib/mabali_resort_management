...
from .models import InventoryItem, FuelTransactionLog, AmmoTransactionLog, GeneratorLog, AmbulanceLog


@admin.register(InventoryItem)
class InventoryItemAdmin(admin.ModelAdmin):
    list_display = ('name', 'category', 'stock_quantity', 'unit', 'supplier', 'created_at')
...
class FuelTransactionLogAdmin(admin.ModelAdmin):
    list_display = ('date', 'inventory_item', 'transaction_status', 'quantity', 'amount', 'created_by')
...
class AmmoTransactionLogAdmin(admin.ModelAdmin):
    list_display = ('date', 'inventory_item', 'transaction_status', 'bullet_quantity', 'payment', 'created_by')
...
class GeneratorLogAdmin(admin.ModelAdmin):
    list_display = ('generator', 'run_hours', 'fuel_used_liters', 'created_by', 'created_at')
...
class AmbulanceLogAdmin(admin.ModelAdmin):
    list_display = ('date', 'patient_name', 'ambulance', 'hospital', 'kms_travelled', 'driver')
